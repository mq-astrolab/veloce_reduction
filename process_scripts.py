...
def process_science_images(imglist, P_id, slit_height=25, MB=None, ronmask=None, MD=None, err_MD=None, scalable=False, saveall=False, path=None, timit=False):
    """
    ...
    for filename in imglist:
        ...
        img = correct_for_bias_and_dark_from_filename(filename, MB, MD, scalable=False, texp=texp, savefile=saveall, path=path, timit=True)
        err = np.sqrt(img + ronmask*ronmask)
